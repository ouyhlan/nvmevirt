...
// discard parameter
#define NAND_4KB_READ_LATENCY_LSB (140000)
#define NAND_4KB_READ_LATENCY_MSB (140000)
#define NAND_4KB_READ_LATENCY_CSB (140000)
#define NAND_READ_LATENCY_LSB (140000)
#define NAND_READ_LATENCY_MSB (140000)
#define NAND_READ_LATENCY_CSB (140000)
#define NAND_PROG_LATENCY (3102000)

#define NAND_READ_LATENCY_SLC (30000) // us
#define NAND_READ_LATENCY_TLC (66000) //us
#define NAND_READ_LATENCY_QLC (140000) //us
#define NAND_PROG_LATENCY_SLC (160000) //us
#define NAND_PROG_LATENCY_TLC (730000) //us
#define NAND_PROG_LATENCY_QLC (3102000) //us
#define NAND_ERASE_LATENCY (0)
